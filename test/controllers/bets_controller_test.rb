...
class BetsControllerTest < ActionController::TestCase
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post :create, bet: { match_id: @bet.match_id, player_id: @bet.player_id, result: @bet.result }
    end
  ...
  test "should update bet" do
    patch :update, id: @bet, bet: { match_id: @bet.match_id, player_id: @bet.player_id, result: @bet.result }
    assert_redirected_to bet_path(assigns(:bet))
  end
